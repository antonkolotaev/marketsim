...
class PlusSpec extends EnsureChanges {

    def plus[A,B,R](a : A, b : B)(implicit m : Plus.OnUnbound[A,B,R]) = m plus(a,b)

    "9 + -4 + - 2 (plus)" should "be 3" in assertResult(plus(plus(9, -4), -2))(3)
    "9.5 + -4 + - 2  (plus)" should "be 3.5" in assertResult(plus(plus(9.5, -4), -2))(3.5)
    "9 + -4.5 + - 2  (plus)" should "be 2.5" in assertResult(plus(plus(9, -4.5), -2))(2.5)
    "9.5 + -4.5 + - 2  (plus)" should "be 3" in assertResult(plus(plus(9.5, -4.5), -2))(3.0)
